...
public class JwtTokenProvider {
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder()
                .setSubject(userDetails.getUsername()) // El subject será el username
                .claim("id_usuario", userId) // Agregar el id_usuario como claim
    ...
    public String getUsername(String token) {
        ...
        return claims.getSubject(); // El username está en el subject
    }
    ...
    public Long getUserId(String token) {
        ...
        return claims.get("id_usuario", Long.class); // Obtener el id_usuario
    }
